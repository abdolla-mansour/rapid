                        ...
                        @foreach ($services as $service)
                            <tr>
                                ...
                                <td>
                                    ...
                                    <button class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modal_{{ $service->id }}">تعديل الخدمة</button>
                                </td>
                            </tr>


                            <!-- Modal -->
                            <div class="modal fade" id="modal_{{ $service->id }}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                        ...
                                        <form method="POST" action="{{ route('admin.service.update', $service->id) }}" enctype="multipart/form-data">
                                            ...
                                            <div class="modal-body">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" value="{{ $service->name }}" name="name" class="form-control" id="recipient-name">
                                                </div>
                                                <div class="form-group">
                                                    <label for="message-text" class="col-form-label">المحتوي:</label>
                                                    <textarea name="content" class="form-control" id="message-text">{{ $service->content }}</textarea>
                                                </div>
                                                <div class="form-group">
