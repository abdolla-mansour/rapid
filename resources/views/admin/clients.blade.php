                        ...
                        @foreach ($clients as $item)
                            <tr>
                                ...
                                <td>
                                    ...
                                    <button class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modal_{{ $item->id }}">تعديل العميل</button>
                                </td>
                            </tr>
                            ...
                            <div class="modal fade" id="modal_{{ $item->id }}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        ...
                                        <form method="POST" action="{{ route('admin.clients.update', $item->id) }}" enctype="multipart/form-data">
                                            @csrf
                                            @method('PUT')
                                            ...
                                            <div class="modal-body">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" value="{{ $item->name }}" name="name" class="form-control" id="recipient-name">
                                                </div>
                                                <div class="form-group">
