                        ...
                        @foreach ($projects as $project)
                            <tr>
                                ...
                                <td>
                                    ...
                                    <button class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modal_{{ $project->id }}">تعديل المشروع</button>
                                </td>
                            </tr>

                            <!-- Modal -->
                            <div class="modal fade" id="modal_{{ $project->id }}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                        ...
                                        <form method="POST" action="{{ route('admin.project.update', $project->id) }}" enctype="multipart/form-data">
                                            ...
                                            <div class="modal-body">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" value="{{ $project->name }}" name="name" class="form-control" id="recipient-name">
                                                </div>
                                                <div class="form-group">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" value="{{ $project->budaget }}" name="budaget" class="form-control" id="recipient-name">
                                                </div>
                                                <div class="form-group">
                                                    <label for="recipient-name" class="col-form-label">العميل:</label>
                                                    <input type="text" value="{{ $project->client }}" name="client" class="form-control" id="recipient-name">
                                                </div>
                                            </div>
